...
const PROVIDERS: ProviderInfo[] = [
  {
    ...
    needsHost: false,
    models: [
      { id: 'gemini-3.1-flash', name: 'Gemini 3.1 Flash (Recommended)', desc: 'Fast, cheap, multi-image + video. Best default.', costPerDetection: 0.001, recommended: true, supportsVideo: true },
